...
from .views import AgregarOrdenCompraView, ListaOrdenesCompraView, EditarOrdenCompraView, EliminarOrdenCompraView, remisiones_orden, detalle_orden
...
urlpatterns = [
    ...
    path('detalle/<int:pk>/', detalle_orden, name='detalle_orden'),
]
